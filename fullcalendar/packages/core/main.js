...
(function (global, factory) {
  ...
  function isNewPropsValid(newProps, calendar) {
    ...
    var props = __assign(
      { businessHours: view ? view.props.businessHours : createEmptyEventStore(), dateSelection: "", eventStore: calendar.state.eventStore, eventUiBases: calendar.eventUiBases, eventSelection: "", eventDrag: null, eventResize: null },
      newProps
    );
  ...
  var CalendarComponent = /** @class */ (function (_super) {
    ...
    CalendarComponent.prototype.computeHeightVars = function () {
      ...
      if (typeof contentHeightInput === "number") {
        ...
        this.viewHeight = Math.round(this.contentEl.getBoundingClientRect().width / Math.max(calendar.opt("aspectRatio"), 0.5));
      }
    };
  ...
  var Slicer = /** @class */ (function () {
    ...
    Slicer.prototype.sliceNowDate = function (
      ...
      return this._sliceDateSpan.apply(this, [{ range: { start: date, end: addMs(date, 1) }, allDay: false }, {}, component].concat(extraArgs));
    };
